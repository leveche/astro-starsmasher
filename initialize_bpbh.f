...
c     used in subroutine dump)
     ...
     $     nrelaxold,trelaxold,dtold
      ...
      if(sin(th1).lt.0.d0) then
         stop 'expecting theta1 to be between 0 and pi'
      endif

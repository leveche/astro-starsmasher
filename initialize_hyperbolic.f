...
c     another expr. for rdot (using eqn. 8.14) and compare
     ...
     $        semilatusrectumprime,semilatusrectum
         stop 'Hyperbolic: semilatusrectum problem. See log.'
      endif
